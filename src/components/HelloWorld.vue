...
<template>
  ...
  <div>
    <main class="z-50 bg-white font-montserrat">
      <nav class="bg-white font-montserrat">
        ...
        >
          <div class="mr-4 md:mr-8">
            <a href="#" rel="home">
              <div class="flex items-center text-2xl font-black text-black">
                <span class="w-6 h-6 mr-4 bg-blue-500 rounded-full"></span
                >Profile
              </div>
            </a>
          </div>
          ...
          >
            <ul
              class="flex flex-col pt-4 mt-4 -mx-4 text-lg border-t  md:flex-row md:items-center md:mx-0 md:ml-auto md:mt-0 md:pt-0 md:border-0"
            >
              <li
                class="block px-4 py-1 text-red-500 transition duration-500 ease-in-out  md:p-2 lg:px-4 font-fredoka-one hover:text-blue-500 hover:translate-x-1"
                href="#"
                v-scroll-to="'#skill'"
              >
                Skill
              ...
              <li
                class="block px-4 py-1 text-red-500  md:p-2 lg:px-4 hover:text-blue-500"
                href="#"
                v-scroll-to="'#info'"
              >
                Info
      ...
      <div v-if="showGoTop" @click="goTop()"><span>fffffffffff</span></div>
      <div
      ...
      >
        <div class="flex flex-col items-start mt-8 sm:w-2/5 sm:mt-0">
          <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
            <strong class="font-black"></strong>
          </h1>
          <h1 class="mb-4 text-3xl leading-none lg:text-3xl"></h1>
          <a
            href="#"
            class="px-8 py-2 text-green-500 border border-green-500 rounded-full "
            >Learn more</a
          >
        </div>
        <div class="sm:w-3/5">
          <img
            ...
            class="bg-center bg-no-repeat bg-auto"
          />
        </div>
      </div>
    </main>
    <div>
      <div
        id="skill"
        class="container flex flex-col px-6 mx-auto mt-20 sm:px-12 sm:flex-row"
      >
        <div class="flex flex-col items-start mt-8 sm:w-2/5 sm:mt-0">
          ...
          <div class="relative flex pt-10 pb-20 sm:items-center md:w-2/3">
            ...
            >
              ...
              <div class="flex-grow mt-6 sm:pl-6 sm:mt-0">
                <h2
                  class="mb-1 text-xl font-medium text-gray-900 title-font"
                ></h2>
    ...
    <div
      id="info"
      class="container flex flex-col-reverse px-6 mx-auto mt-20  sm:px-12 sm:flex-row"
    >
      <div class="flex flex-col items-start mt-8 sm:w-2/5 sm:mt-0">
        <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
          <strong class="text-gray-200 text-8xl">I</strong>
        </h1>
        <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
          <strong class="text-gray-200 text-8xl">N</strong>
        </h1>
        <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
          <strong class="text-gray-200 text-8xl">F</strong>
        </h1>
        <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
          <strong class="text-gray-200 text-8xl">O</strong>
        </h1>
      </div>
    ...
    <footer class="w-full py-8 bg-white dark:bg-gray-800" id="contact">
      <div class="max-w-screen-xl px-4 mx-auto">
        <ul
          class="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light "
        >
          <li class="my-2">
            <a
              class="text-gray-200 transition-colors duration-200  hover:text-gray-800 dark:text-gray-300 dark:hover:text-white"
              href="#"
            >
              FAQ
            </a>
