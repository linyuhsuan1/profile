...
<div>
  <main class="bg-white font-montserrat">
    <header class="z-40 flex items-center h-24 -mt-6 sm:h-32">
      <div class="container flex items-center justify-between mx-auto">
        ...
        <div class="flex items-center">
          <nav class="items-center hidden text-lg text-black lg:flex">
            ...
            <a href="#" class="flex px-6 py-2 tracking-widest text-red-500 font-fredoka-one hover:text-blue-500" >Home</a>
            <a href="#" class="flex px-6 py-2 text-red-500 hover:text-blue-500" v-scroll-to="'#skill'">Skill</a>
            <a href="#" class="flex px-6 py-2 text-red-500 hover:text-blue-500" v-scroll-to="'#info'">Info</a>
            <a href="#" class="flex px-6 py-2 text-red-500 text-blue-500"  v-scroll-to="'#contact'">Contact me</a>
          </nav>
    ...
    <div class="container flex flex-col-reverse items-center px-6 mx-auto sm:px-12 sm:flex-row">
      <div class="flex flex-col items-start mt-8 sm:w-2/5 sm:mt-0">
        <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
          <strong class="font-black ">Fronted-End</strong>
        </h1>
        <h1 class="mb-4 text-3xl leading-none lg:text-3xl">
         
        </h1>
        <a href="#" class="px-8 py-2 text-green-500 border border-green-500 rounded-full">Learn more</a>
      </div>
      <div class="sm:w-3/5">
        <img src="../../src/assets/Group1.png" class="aspect-w-20 aspect-h-3 opacity-20" />
      </div>
    </div>
  </main>
  <div id="skill" class="container flex flex-col-reverse items-center px-6 mx-auto mt-20 sm:px-12 sm:flex-row">
    <div class="flex flex-col items-start mt-8 sm:w-2/5 sm:mt-0">
      <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
        <strong class="text-gray-200 text-8xl">S</strong>
      </h1>
      <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
        <strong class="text-gray-200 text-8xl">K</strong>
      </h1>
      <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
        <strong class="text-gray-200 text-8xl">I</strong>
      </h1>
      <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
        <strong class="text-gray-200 text-8xl">L</strong>
      </h1>
      <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
        <strong class="text-gray-200 text-8xl">L</strong>
      </h1>
    ...
    <div id="info" class="container flex flex-col-reverse items-center px-6 mx-auto mt-20 sm:px-12 sm:flex-row">
    <div class="flex flex-col items-start mt-8 sm:w-2/5 sm:mt-0">
      <h1 class="mb-4 text-4xl leading-none lg:text-5xl">
        <strong class="text-gray-200 text-8xl">I</strong>
      </h1>
