      ...
      <div>
        <div class="container flex flex-col-reverse items-center px-6 mx-auto text-center sm:px-12 sm:flex-row">
          <div class="flex flex-col items-center mt-8 sm:w-2/5 sm:mt-0">
            ...
            <h1 class="mb-4 text-xl text-[#78716c] leading-none inline-flex">liny7544@gmail.com</h1>
            <div class="flex flex-row justify-center">
             <a href="https://www.linkedin.com/in/yu-hsuan-lin-75b27115b/" target="_blank" class="text-[#78716c] transition-colors duration-200 hover:text-gray-800 ">
             ...
             <a href="https://github.com/linyuhsuan1"  target="_blank" class="text-[#78716c] transition-colors duration-200 hover:text-gray-800 " style="margin-left:14%">
